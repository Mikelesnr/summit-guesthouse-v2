...
const GREETING =
    "Hi, I'm the Summit Lodge assistant. Ask me about room prices, availability for your dates, or how booking works — or tap the WhatsApp button if you'd rather chat with our team directly.";
        ...
        try {
            ...
            setMessages([
                ...next,
                {
                    ...
                    content:
                        data.reply ??
                        "Sorry, I couldn't reach the assistant just now — try WhatsApp instead.",
                },
            ]);
        } catch {
            setMessages([
                ...next,
                {
                    role: 'assistant',
                    content:
                        'Sorry, something went wrong. Try WhatsApp instead.',
                },
            ]);
        } finally {
            setSending(false);
    ...
    return (
        <div ref={widgetRef} className="fixed bottom-6 left-6 z-40">
            ...
            <button
                ...
                className="flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lift transition hover:opacity-90 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2"
            >
                {open ? (
