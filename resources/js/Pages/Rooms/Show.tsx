    ...
    return (
        <SiteLayout>
            ...
            <section className="mx-auto max-w-6xl px-6 py-12">
                ...
                <div className="mt-6 aspect-[16/7] overflow-hidden rounded-2xl bg-cream-deep shadow-card">
                    <img
                        src={`/images/rooms/${room.slug}/full.jpeg`}
                        alt={`${room.name} room overview`}
                ...
                {images.length > 0 && (
                    <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
                        {images
                            .filter((img) => !img.path.includes('full.jpeg'))
                            .map((img) => (
                                <div
                                    key={img.id}
                                    className="aspect-[4/3] overflow-hidden rounded-xl bg-cream-deep"
                                >
                                    <img
                                        src={img.path}
